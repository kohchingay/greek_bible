...
df = pd.DataFrame(
    ...
    "Percentage": [int(100*wordcount_Mt/wordcount_nt), int(100*wordcount_Mk/wordcount_nt), int(100*wordcount_Lk/wordcount_nt), int(100*wordcount_Jn/wordcount_nt), int(100*wordcount_Ac/wordcount_nt), int(100*wordcount_Ro/wordcount_nt), int(100*wordcount_1Co/wordcount_nt), int(100*wordcount_2Co/wordcount_nt), int(100*wordcount_Ga/wordcount_nt), int(100*wordcount_Eph/wordcount_nt), int(100*wordcount_Php/wordcount_nt), int(100*wordcount_Col/wordcount_nt), int(100*wordcount_1Th/wordcount_nt), int(100*wordcount_2Th/wordcount_nt), int(100*wordcount_1Ti/wordcount_nt), int(100*wordcount_2Ti/wordcount_nt), int(100*wordcount_Tit/wordcount_nt), int(100*wordcount_Phm/wordcount_nt), int(100*wordcount_Heb/wordcount_nt), int(100*wordcount_Jas/wordcount_nt), int(100*wordcount_1Pe/wordcount_nt), int(100*wordcount_2Pe/wordcount_nt), int(100*wordcount_1Jn/wordcount_nt), int(100*wordcount_2Jn/wordcount_nt), int(100*wordcount_3Jn/wordcount_nt), int(100*wordcount_Jud/wordcount_nt), int(100*wordcount_Re/wordcount_nt)]
    }
)

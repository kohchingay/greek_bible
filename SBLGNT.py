...
df = pd.DataFrame(
    ...
    "Percentage": [{wordcount_Mt/wordcount_nt}, {wordcount_Mk/wordcount_nt}, {wordcount_Lk/wordcount_nt}, {wordcount_Jn/wordcount_nt}, {wordcount_Ac/wordcount_nt}, {wordcount_Ro/wordcount_nt}, {wordcount_1Co/wordcount_nt}, {wordcount_2Co/wordcount_nt}, {wordcount_Ga/wordcount_nt}, {wordcount_Eph/wordcount_nt}, {wordcount_Php/wordcount_nt}, {wordcount_Col/wordcount_nt}, {wordcount_1Th/wordcount_nt}, {wordcount_2Th/wordcount_nt}, {wordcount_1Ti/wordcount_nt}, {wordcount_2Ti/wordcount_nt}, {wordcount_Tit/wordcount_nt}, {wordcount_Phm/wordcount_nt}, {wordcount_Heb/wordcount_nt}, {wordcount_Jas/wordcount_nt}, {wordcount_1Pe/wordcount_nt}, {wordcount_2Pe/wordcount_nt}, {wordcount_1Jn/wordcount_nt}, {wordcount_2Jn/wordcount_nt}, {wordcount_3Jn/wordcount_nt}, {wordcount_Jud/wordcount_nt}, {wordcount_Re/wordcount_nt}]
    }
)
st.table(df)

...
df = pd.DataFrame(
    ...
    "Percentage": [{wordcount_Mt/wordcount_nt:.0f}, {wordcount_Mk/wordcount_nt:.0f}, {wordcount_Lk/wordcount_nt:.0f}, {wordcount_Jn/wordcount_nt:.0f}, {wordcount_Ac/wordcount_nt:.0f}, {wordcount_Ro/wordcount_nt:.0f}, {wordcount_1Co/wordcount_nt:.0f}, {wordcount_2Co/wordcount_nt:.0f}, {wordcount_Ga/wordcount_nt:.0f}, {wordcount_Eph/wordcount_nt:.0f}, {wordcount_Php/wordcount_nt:.0f}, {wordcount_Col/wordcount_nt:.0f}, {wordcount_1Th/wordcount_nt:.0f}, {wordcount_2Th/wordcount_nt:.0f}, {wordcount_1Ti/wordcount_nt:.0f}, {wordcount_2Ti/wordcount_nt:.0f}, {wordcount_Tit/wordcount_nt:.0f}, {wordcount_Phm/wordcount_nt:.0f}, {wordcount_Heb/wordcount_nt:.0f}, {wordcount_Jas/wordcount_nt:.0f}, {wordcount_1Pe/wordcount_nt:.0f}, {wordcount_2Pe/wordcount_nt:.0f}, {wordcount_1Jn/wordcount_nt:.0f}, {wordcount_2Jn/wordcount_nt:.0f}, {wordcount_3Jn/wordcount_nt:.0f}, {wordcount_Jud/wordcount_nt:.0f}, {wordcount_Re/wordcount_nt:.0f}]
    }
)
st.table(df)
